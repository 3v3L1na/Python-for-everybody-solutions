...
# www.py4e.com/code3/geoxml.py to print out the two-character country code from the retrieved data. 
# Add error checking so you program does not traceback if#the country code is not there. 
